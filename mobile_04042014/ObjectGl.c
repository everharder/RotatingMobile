...
void rotate_object(object_gl *object, float degree) {
	orbit_object(object, degree, object->x, object->y, object->z);
}

/******************************************************************
* rotate object native
*
* This function rotates a 3d object by a value scaled by its inherited
* parameter rotation_spd
*******************************************************************/
void rotate_object_native(object_gl *object) {
	rotate_object(object,  object->rotation_spd * object->rotation_dir);
}
